...
const ConfirmBlock: React.FC<ConfirmBlockProps> = ({
    ...
    return (
        <div className='block-cancelation'>
            <div className='confirm-info-customer'>
                <div className='title'>
                    <h2>
                ...
                <div className="main">
                    ...
                    <p className='max-lg:!text-sm'>
                        Are you sure you want to block <span>{selectedName}?</span> Blocking a user will prevent them from interacting with your profile or content. This action is irreversible.
                    </p>
                </div>
