...
const SingleBookingPage: React.FC = () => {
  ...
  const handleSelectPromo = (promo: string) => {
    ...
    setCouponDropdown(true); // Закрываем дропдаун после выбора
  };
  ...
  const handleSelectCard = (promo: string) => {
    ...
    setDebitCardDropdown(true); // Закрываем дропдаун после выбора
  };
          ...
          <div className='confirm-details'>
            ...
            <div className="spotify">
              <div className='text-side'>
                ...
                <button>Join Spotify Blend</button>
              </div>
            ...
            <div className='contact-info'>
              ...
              <form action=''>
                ...
                <div className='checkbox'>
                  <div
                    className={`checkbox-block ${activeCheckbox === true ? 'active' : ''}`}
                    onClick={handleClickCheckbox}
                  >
                    <img
                      className={`${activeCheckbox === true ? 'active' : ''}`}
                      src='/images/booking/check-white.svg'
                      alt=''
                    />
                  </div>
                ...
                <div className='attending'>
                  ...
                  <p>
                    They will receive an invitation from you and in case of
                    accepting they will be charged with the same amount
                  </p>
                  <input
                    type='text'
                    placeholder='Person 1 - Email or Phone Number'
                    value={attendingFirst}
                    onChange={handleAttendingFirst}
                  />
                  <input
                    type='text'
                    placeholder='Person 2 - Email or Phone Number'
                    value={attendingSecond}
                    onChange={handleAttendingSecond}
                  />
                  <div className='checkbox'>
                    <div
                      className={`checkbox-block ${oneIsMe === true ? 'active' : ''}`}
                      onClick={handleClickOneIsMe}
                    >
                      <img
                        className={`${oneIsMe === true ? 'active' : ''}`}
                        src='/images/booking/check-white.svg'
                        alt=''
                      />
                    </div>
                    <p>One of the attenders is me</p>
                  </div>
                </div>
                <div className='payment'>
                  <h2>Payment</h2>
                  <div
                    className={`pay-full ${payFull === true ? 'active' : ''}`}
                    onClick={handlePayFull}
                  >
                    <p>Pay in full</p>
                    <p>Pay total now (50 CHF) and you are all set</p>
                    <div
                      className={`checkbox ${payFull === true ? 'active' : ''}`}
                    ></div>
                    <div
                      className={`check-circle ${payFull === true ? 'active' : ''}`}
                    >
                      <Image
                        className={`${payFull === true ? 'active' : ''}`}
                        src='/images/booking/check-mark-dark.svg'
                        alt='checked'
                        width={7}
                        height={7}
                      />
                  ...
                  <div
                    className={`pay-part ${payPart === true ? 'active' : ''}`}
                    onClick={handlePayPart}
                  >
                    <p>Pay part now, part later</p>
                    <p>
                      Pay part now (25 CHF), and other half (25 CHF) one day
                      before reservation
                    </p>
                    <div
                      className={`checkbox ${payPart === true ? 'active' : ''}`}
                    ></div>
                    <div
                      className={`check-circle ${payPart === true ? 'active' : ''}`}
                    >
                      <Image
                        className={`${payPart === true ? 'active' : ''}`}
                        src='/images/booking/check-mark-dark.svg'
                        alt='checked'
                        width={7}
                        height={7}
                ...
                <div className='pay-with'>
                  ...
                  <div className='debit-card' onClick={hanleDebitCardDropdown}>
                    <div>
                      <div>
                        <Image
                          src={'/images/booking/CreditCardOutline.svg'}
                          alt='coupon'
                          width={20}
                          height={20}
                        />
                    ...
                    <div
                      className={`dropdown-icon ${debitCardDropdown ? 'active' : ''}`}
                    >
                      <Image
                        src={'/images/booking/arrow-down.svg'}
                        alt='arrow'
                        width={12}
                        height={12}
                      ></Image>
                    ...
                    <div
                      className={`card-dropdown ${debitCardDropdown ? 'active' : ''}`}
                    >
                      <p onClick={() => handleSelectCard('Credit')}>Credit</p>
                      <p onClick={() => handleSelectCard('Debit Card')}>
                        Debit Card
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='checkbox'>
                    <div
                      className={`checkbox-block ${saveCard === true ? 'active' : ''}`}
                      onClick={hanleSaveCard}
                    >
                      <img
                        className={`${saveCard === true ? 'active' : ''}`}
                        src='/images/booking/check-white.svg'
                        alt=''
                      />
                    </div>
                ...
                <div className='policy max-lg:hidden'>
                  ...
                  <p>
                    Free cancellation <span> before Jul 6. </span> Cancel before
                    check-in on <span> Jul 24 </span> for a partial refund.{' '}
                    <a href='#'>Learn More</a>
                  </p>
                </div>
              </form>
