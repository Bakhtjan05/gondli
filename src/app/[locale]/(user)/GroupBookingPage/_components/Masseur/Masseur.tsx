      ...
      <div className='masseur-col'>
        ...
        >
          <div className='circle'>
            <Image
              src='/images/booking/Sparkles.svg'
              alt='masseur'
              width={60}
              height={60}
            />
          ...
          <div
            className={`checkbox ${choosenMasseure === null ? 'active' : ''}`}
          ></div>
          <div
            className={`check-circle ${choosenMasseure === null ? 'active' : ''}`}
          >
            <Image
              className={`${choosenMasseure === null ? 'active' : ''}`}
        ...
        {masseursData.map((masseur, index) => (
          <div
            className={`masseur-block ${choosenMasseure === index ? 'active' : ''}`}
            key={index}
            onClick={() => handleChoosenMasseure(index)}
          >
            <div>
              <Image
            ...
            <div
              className={`checkbox ${choosenMasseure === index ? 'active' : ''}`}
            ></div>
            <div
              className={`check-circle ${choosenMasseure === index ? 'active' : ''}`}
            >
              <Image
                className={`${choosenMasseure === index ? 'active' : ''}`}
                src='/images/booking/check-mark-dark.svg'
                alt='checked'
                width={8}
                height={8}
