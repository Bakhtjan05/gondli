...
const ReservationPage: React.FC = () => {
  ...
  const contactInformation = {
    name: "Madeline Hintz",
    email: "Eula_Ziemann89@gmail.com",
    phoneNumber: "+41 32 327-55-11",
  };
            ...
            <div className="checkin-details">
              ...
              <div className='check-in-block'>
                ...
                <div className="choosen-service">
                  <div>
                    <p>{checkinDetails.service.name}</p>
                    <p>Chosen Service</p>
                  </div>
                  <button >
                ...
                <div className="choosen-date">
                  <div>
                    <p>{checkinDetails.date.selectedDate}</p>
                    <p>Chosen Date</p>
                  </div>
                  <button >
                    <Image src="/images/booking/edit.svg" alt="" width={16} height={16} />
                ...
                <div className="choosen-time">
                  <div>
                    <p>{checkinDetails.time.selectedTime}</p>
